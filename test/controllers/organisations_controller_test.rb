...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { description: @organisation.description, name: @organisation.name } }, as: :json
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { description: @organisation.description, name: @organisation.name } }, as: :json
    assert_response 200
  end
